...
// Seed bai viet mau neu DB trong
if (db.prepare('SELECT COUNT(*) as c FROM articles').get().c === 0) {
  const _sd = [
    { title: 'iPhone 17 Pro lo dien thiet ke moi: Camera 48MP, chip A19 Pro', excerpt: 'Apple trang bi cho iPhone 17 Pro cam bien 48MP the he tiep theo cung chip A19 Pro hieu nang vuot troi so the he truoc.', content: '<p>Chip A19 Pro san xuat tren tien trinh 2nm cua TSMC, hieu nang CPU va GPU tang 30%, tiet kiem dien 20%. Camera 48MP khau do f/1.6 chup dem vuot troi. Pin lon hon, sac nhanh 45W.</p>', thumbnail: 'https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?w=800&q=80', category: 'mobile', tags: '["Apple","iPhone","smartphone"]', is_featured: 1, status: 'published' },
    { title: 'Google Gemini 2.0 Ultra vuot GPT-4o tren moi benchmark', excerpt: 'Google ra mat Gemini 2.0 Ultra voi kha nang ly luan vuot troi va context window 2 trieu token.', content: '<p>Gemini 2.0 Ultra dat diem vuot troi tren MMLU, HumanEval va MATH. Context window 2 trieu token xu ly tai lieu dai va codebase phuc tap. Tich hop vao Google Search, Gmail, Workspace.</p>', thumbnail: 'https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=800&q=80', category: 'ai', tags: '["Google","Gemini","AI"]', is_featured: 1, status: 'published' },
    { title: 'Samsung Galaxy S25 Ultra: Snapdragon 8 Elite, S Pen AI, camera 200MP', excerpt: 'Galaxy S25 Ultra flagship dinh cao voi chip Snapdragon 8 Elite, S Pen tich hop AI va camera 200MP.', content: '<p>Snapdragon 8 Elite tang CPU 37%, GPU 30%. S Pen AI do tre 2.8ms nhan dang chu viet thong minh. Camera 200MP AI zoom 10x quang hoc.</p>', thumbnail: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=800&q=80', category: 'mobile', tags: '["Samsung","Galaxy S25","Android"]', is_featured: 0, status: 'published' },
    { title: 'NVIDIA RTX 5090: GPU manh nhat lich su, hieu nang tang 70%', excerpt: 'RTX 5090 kien truc Blackwell, 32GB GDDR7, gaming 4K vuot RTX 4090 den 70%.', content: '<p>32GB GDDR7 bang thong 1.8TB/s, 21.760 CUDA core. DLSS 4 Multi Frame Generation tao frame ao muot ma. Gia tu 50 trieu dong tai Viet Nam.</p>', thumbnail: 'https://images.unsplash.com/photo-1591488320449-011701bb6704?w=800&q=80', category: 'general', tags: '["NVIDIA","RTX 5090","GPU","gaming"]', is_featured: 0, status: 'published' },
    { title: 'Meta AI len WhatsApp, Instagram, Facebook - ho tro tieng Viet', excerpt: 'Meta tich hop tro ly AI Llama 4 vao toan bo he sinh thai, ho tro tieng Viet tot.', content: '<p>Meta AI dua tren Llama 4 canh tranh GPT-4o. Chat, tao noi dung, chinh sua anh truc tiep trong app. Ho tro tieng Viet cho hang trieu nguoi dung.</p>', thumbnail: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=800&q=80', category: 'internet', tags: '["Meta","AI","WhatsApp","Llama"]', is_featured: 0, status: 'published' },
    { title: 'Viet Nam phu song 5G toan quoc: Toc do dat 1.2Gbps tai Ha Noi', excerpt: 'Viettel va VNPT hoan thanh phu song 5G 63 tinh thanh, toc do thuc te vuot 1Gbps.', content: '<p>Toc do download Ha Noi dat 1.2Gbps, upload 200Mbps, do tre 5-10ms. Gia cuoc tu 100.000d/thang cho 100GB. Mo ra ung dung game cloud, IoT cong nghiep.</p>', thumbnail: 'https://images.unsplash.com/photo-1562408590-e32931084e23?w=800&q=80', category: 'internet', tags: '["5G","Viettel","VNPT","Viet Nam"]', is_featured: 0, status: 'published' },
    { title: 'MacBook Pro M4 Max: Man OLED lan dau, pin 22 gio ky luc', excerpt: 'MacBook Pro M4 Max man hinh OLED dau tien, chip cuc manh va pin 22 gio.', content: '<p>Man OLED 1.600 nit, tuong phan vo cuc. M4 Max 16 nhan CPU, 40 nhan GPU. Pin 22 gio lam viec lien tuc khong can sac.</p>', thumbnail: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=800&q=80', category: 'mobile', tags: '["Apple","MacBook","M4","laptop"]', is_featured: 1, status: 'published' },
    { title: 'ChatGPT o3 giai toan olympiad, lap trinh nhu chuyen gia', excerpt: 'OpenAI o3 dat 87.5% tren ARC-AGI, giai duoc bai toan olympiad va code ngang chuyen gia.', content: '<p>ARC-AGI dat 87.5%, gan nguong AGI. Tu thiet ke kien truc phan mem, viet code, debug chat luong cao. Giai nhieu bai toan olympiad quoc te.</p>', thumbnail: 'https://images.unsplash.com/photo-1655720828018-edd2daec9349?w=800&q=80', category: 'ai', tags: '["OpenAI","ChatGPT","o3","AGI"]', is_featured: 1, status: 'published' },
    { title: 'Xiaomi 15 Ultra: Camera Leica 1 inch, sac 120W, gia 25 trieu', excerpt: 'Xiaomi 15 Ultra cam bien Sony 1 inch, kinh Leica Summilux va sac 120W day pin 19 phut.', content: '<p>Camera Sony IMX9 1 inch, f/1.4-4.0 dieu chinh, kinh Leica Summilux. Sac 120W day pin 19 phut. Snapdragon 8 Elite, RAM 16GB, OLED 120Hz. Gia 25 trieu.</p>', thumbnail: 'https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=800&q=80', category: 'mobile', tags: '["Xiaomi","Leica","flagship"]', is_featured: 0, status: 'published' },
    { title: 'Starlink Mini ra mat Viet Nam: Internet ve tinh 150Mbps vung sau', excerpt: 'SpaceX mo dang ky Starlink Mini tai Viet Nam, thiet bi 7.5 trieu, cuoc 1.2 trieu/thang.', content: '<p>Mini nang 1.1kg, gap gon vua ba lo. Toc do thuc te 80-150Mbps, do tre 40-60ms. Phu hop mien nui, nong thon. Goi 1.2 trieu/thang khong gioi han data.</p>', thumbnail: 'https://images.unsplash.com/photo-1516849677043-ef67c9557e16?w=800&q=80', category: 'internet', tags: '["Starlink","SpaceX","Viet Nam"]', is_featured: 0, status: 'published' },
  ];
  const _ins = db.prepare('INSERT INTO articles (title,excerpt,content,thumbnail,category,tags,is_featured,status) VALUES (?,?,?,?,?,?,?,?)');
  const _tx = db.transaction((list) => { for (const a of list) _ins.run(a.title,a.excerpt,a.content,a.thumbnail,a.category,a.tags,a.is_featured,a.status); });
  _tx(_sd);
  console.log('[SEED] ' + _sd.length + ' bai viet mau da duoc tao');
}
// Prepared statements
const stmt = {
  // Articles
...
// GET /api/admin/stats/article/:id
app.get('/api/admin/stats/article/:id',  (req, res) => {
  const id = parseInt(req.params.id);
  const article = stmt.articleById.get(id);
  if (!article) return err(res, 'Không tìm thấy bài viết', 404);
...
// GET /api/admin/stats/readers
app.get('/api/admin/stats/readers',  (req, res) => {
...
function runCleanup() {
  try {
    // Bước 1: Gom page_views > 7 ngày vào daily_summary
    db.prepare(`INSERT INTO daily_summary (day,article_id,total_views,unique_sessions)
      SELECT date(pv.created_at),pv.article_id,COUNT(*),COUNT(DISTINCT pv.session_id)
      FROM page_views pv WHERE pv.created_at < datetime('now','-7 days')
      GROUP BY date(pv.created_at),pv.article_id
      ON CONFLICT(day,article_id) DO UPDATE SET total_views=excluded.total_views,unique_sessions=excluded.unique_sessions`).run();
    db.prepare(`INSERT INTO daily_summary (day,article_id,avg_read_percent)
      SELECT date(rs.started_at),rs.article_id,AVG(rs.read_percent)
      FROM read_sessions rs WHERE rs.started_at < datetime('now','-7 days')
      GROUP BY date(rs.started_at),rs.article_id
      ON CONFLICT(day,article_id) DO UPDATE SET avg_read_percent=excluded.avg_read_percent`).run();
    console.log('[Cleanup] Gom daily_summary xong');
    // Bước 2: Xóa raw data > 30 ngày
    const pvDel = db.prepare(`
      DELETE FROM page_views
      WHERE created_at < datetime('now', '-30 days')
    `).run();

    // Xóa read_sessions cũ hơn 30 ngày
...
// Keep-alive ping mỗi 12 phút
const _http = require('http'), _https = require('https');
function keepAlive() {
  const u = process.env.RENDER_EXTERNAL_URL;
  if (!u) return;
  const m = u.startsWith('https') ? _https : _http;
  m.get(u + '/api/articles?limit=1', r => console.log('[KeepAlive] ping OK', r.statusCode))
   .on('error', e => console.log('[KeepAlive] ping fail:', e.message));
}
